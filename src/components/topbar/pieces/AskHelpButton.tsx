...
export default function AskHelpButton() {
  ...
  return (
    <button 
      className="bg-linear-to-br from-(--main-green) to-(--main-green-dark) shadow-lg cursor-pointer rounded-2xl text-slate-100 px-20 ease-in-out duration-300 transition-all hover:scale-102 hover:shadow-xl active:scale-99"
